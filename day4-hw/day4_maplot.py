...
M = np.log2(df["SRR072893"]+1) - np.log2(df["SRR072894"]+1)
A = (np.log2(df["SRR072893"] + 1) + np.log2(df["SRR072894"]+1)) * .5

fig, ax = plt.subplots()
ax.scatter( A, M )
# ax.plot( [0, 10], [-2, 2] )
fig.suptitle("MA plot for SRR072893 vs. SRR072894 samples")
